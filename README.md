...
- [x] Two-person pipeline (2026-08-02) — Devansh Pathak added (authorized 2026-08-02): scout registers Isha; after her approvals hit the calendar, a chained one-shot task registers Devansh via his own Chrome profile (identity-guarded, own profile file) and adds him as attendee so events land on his GCal. scout.db is now per-person (UNIQUE link+person). One-off backfill scheduled for the 8 approved events.
